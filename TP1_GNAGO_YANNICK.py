...
""" Formules d'integration composites """
""" 1) Rectangle Gauche """
...
"""test pour trouver l'ordre a faire dans la console
ordre_courbe(lambda x: (x**3)+2*(x**2)+x+1,-1,12,6420.91)
ordre_courbe(lambda x: 21*(x**7)+(x**5)+12,-5,11,561959520)
ordre_courbe(lambda x: exp(-x**2),1,10,0.13940)
"""